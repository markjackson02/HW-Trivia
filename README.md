...
Still working on this, please hold off on grading! 
...
3. Don't forget to include a script tag wi of the `TriviaGame` folder called `index.html`. This is where you'll mark up all of your HTML.th the jQuery library.
